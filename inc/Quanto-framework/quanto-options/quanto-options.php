    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'title'    => esc_html__( 'Header Options', 'quanto' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'type'     => 'switch',
                'title'    => esc_html__( 'Post Auhtor', 'quanto' ),
                'subtitle' => esc_html__( 'Switch On to Display Post Author.', 'quanto' ),
                'default'  => false,
                'on'        => esc_html__( 'Enabled', 'quanto'),
                'off'       => esc_html__( 'Disabled', 'quanto'),
            ),
   ...
   Redux::setSection( $opt_name, array(
       ...
       'fields'     => array(
            array(
               ...
               'title'    => esc_html__( 'Footer Builder', 'quanto' ),
            ),
            array(
               ...
               'title'    => esc_html__( 'Select Footer', 'quanto' ),
